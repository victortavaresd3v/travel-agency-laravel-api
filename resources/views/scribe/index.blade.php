...
<div class="tocify-wrapper">
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: November 1, 2023</li>
    </ul>
</div>
...
<div class="bash-example">
    ...
    \"is_public\": true,
    \"name\": \"quisquam\",
    \"description\": \"Veritatis minima autem dignissimos aliquam quis laborum.\",
    \"number_of_days\": 2
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Veritatis minima autem dignissimos aliquam quis laborum."
               data-component="body">
    <br>
<p>Example: <code>Veritatis minima autem dignissimos aliquam quis laborum.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/travels/veniam/tours" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"ybvp\",
    \"starting_date\": \"2023-11-01T23:05:35\",
    \"ending_date\": \"2061-07-15\",
    \"price\": 1.77101
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the travel. Example: <code>veniam</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>ybvp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="2023-11-01T23:05:35"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2023-11-01T23:05:35</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>starting_date</code>. Example: <code>2061-07-15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    "http://localhost/api/v1/admin/travels/aliquid/delete" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the travel. Example: <code>aliquid</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    ...
    "http://localhost/api/v1/admin/travels/voluptates/update" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"is_public\": true,
    \"name\": \"voluptatem\",
    \"description\": \"Enim magnam temporibus quod ipsa sed repellat officia molestias.\",
    \"number_of_days\": 12
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the travel. Example: <code>voluptates</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>is_public</code></b>&nbsp;&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Enim magnam temporibus quod ipsa sed repellat officia molestias."
               data-component="body">
    <br>
<p>Example: <code>Enim magnam temporibus quod ipsa sed repellat officia molestias.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>number_of_days</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"email\": \"dickens.dallin@example.org\",
    \"password\": \"GH![T%?\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="dickens.dallin@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>dickens.dallin@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 6 characters. Must not be greater than 255 characters. Example: <code>GH![T%?</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/travels?page=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/travels/&amp;quot;the-travel&amp;quot;/tours?page=1&amp;priceFrom=0&amp;priceTo=0&amp;dateFrom=%222023-06-01%22&amp;dateTo=%222023-07-01%22&amp;sortBy=%22price%22&amp;sortOrder=%22asc%22+or+%22desc%22" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"priceFrom\": 23,
    \"priceTo\": 25053.259525,
    \"dateFrom\": \"2023-11-01T23:05:35\",
    \"dateTo\": \"2023-11-01T23:05:35\",
    \"sortBy\": \"price\",
    \"sortOrder\": \"asc\"
}"
</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/travels/&amp;quot;the-travel&amp;quot;/tours"
);
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>25053.259525</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>dateFrom</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
